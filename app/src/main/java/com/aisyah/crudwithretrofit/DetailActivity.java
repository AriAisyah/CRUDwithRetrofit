...
import com.aisyah.crudwithretrofit.data.ResponseSiswa;
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtalamat = findViewById(R.id.etnalamat);
    ...
    private void DeleteData(String id) {
        apiService.hapusData(id).enqueue(new Callback<ResponseSiswa>() {
            ...
            public void onFailure(Call<ResponseSiswa> call, Throwable t) {
                Toast.makeText(DetailActivity.this, "Server is down on file", Toast.LENGTH_SHORT).show();
            }
        });
    }
